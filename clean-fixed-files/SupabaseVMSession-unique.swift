...
/// Unique ShaydZ virtual machine session model
public struct ShaydZUnique_SupabaseVMSession: Identifiable, Codable, Equatable {
    ...
    public static func == (lhs: ShaydZUnique_SupabaseVMSession, rhs: ShaydZUnique_SupabaseVMSession) -> Bool {
        return lhs.id == rhs.id
    }
    
    public static var mockSession: ShaydZUnique_SupabaseVMSession {
        return ShaydZUnique_SupabaseVMSession(
            id: "mock-session-id",
            userId: "mock-user-id",
            status: "active",
...
public typealias SupabaseVMSession = ShaydZUnique_SupabaseVMSession
